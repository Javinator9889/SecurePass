...
public class DisplayUnitsConverter {
     ...
     */
    public static float dpToPx(@NotNull Context context, final float dp) {
     ...
     * @return A float value to represent dp equivalent to px value
     */
    public static float pxToDp(@NotNull Context context, final float px) {
     ...
     * @return A float value to represent px equivalent to sp depending on device density and user's text scale options
     */
    public static float spToPx(@NotNull Context context, final float sp) {
     ...
     * @return A float value to represent sp equivalent to px depending on device density and user's text scale options
     */
    public static float pxToSp(@NotNull Context context, final float px) {
