 ...
 */
public class SecurityCodesOperations extends CommonOperations implements
        ISecurityCodesSetOperations, ISecurityCodesGetOperations {
     ...
     */
    public SecurityCodesOperations(@NonNull DatabaseManager databaseManager,
