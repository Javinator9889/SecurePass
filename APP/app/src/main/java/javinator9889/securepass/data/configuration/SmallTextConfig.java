 ...
 */
public class SmallTextConfig implements IConfigFields, Serializable {
    ...
    public SmallTextConfig(long id, @Nullable String description, int sortOrder, long configId) {
        this.id = id;
